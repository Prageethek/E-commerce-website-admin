...
const Add = () => {
  ...
  // state variable for store images
  const [image1,setImage1] = useState(false)
  const [image2,setImage2] = useState(false)
  const [image3,setImage3] = useState(false)
  const [image4,setImage4] = useState(false)

  // state variable for product {name,price,description,size}
...
<div className='flex gap-2'>
  ...
  <label htmlFor="image4"> 
    ...
    <div className='w-full '>
      ...
      <input onChange={(e)=>setImage1(e.target.files[0])} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Type here' required/>
    </div>
